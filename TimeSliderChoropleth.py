...
class MyTimeSliderChoropleth(JSCSSMixin, GeoJson):
    """
    ...
    def __init__(self, data, timestamps, style_function=None, highlight_function=None,  # noqa
        ...
        super(MyTimeSliderChoropleth, self).__init__(data, style_function=style_function, highlight_function=highlight_function, # noqa
